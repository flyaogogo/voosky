   ...
   <div class="mainBox" style="">
    ...
    <h3><a href="javascript:void(0)" class="actionBtn vs-nav-add-btn-cls">添加导航</a>自定义导航栏</h3>
     <ul class="tab">
      ...
      <li><a href="javascript:void(0)" class="vs-nav-botton-tab">底部</a></li>
     </ul>
...
<%--     <script type="text/javascript">
    ...
    <div class="idTabs vs-nav-add-idtab-cls" style="display: none;">
     <h3><a href="javascript:void(0)" class="actionBtn returnActionBtn">返回列表</a>自定义导航栏</h3>
      <ul class="tab">
         ...
         <form action="${ctx }/nav/addNavAction.html" method="post">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
           ...
           <tr>
            ...
            <td>
             <label for="type_0">
              <input type="radio" name="navType" id="type_0" value="middle" checked="true" onChange="">
            	  主导航</label>
             <label for="type_1">
