package com.tmwrk.voosky.web.servlet;
...
public class AuthImg extends HttpServlet
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4654934982650942237L;
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		for (int i = 0; i < 4; i++)
		{
			...
			if (tmp.equalsIgnoreCase("0") || tmp.equalsIgnoreCase("o") || tmp.equalsIgnoreCase("i")
					|| tmp.equalsIgnoreCase("l"))
			{
				tmp = getRandomChar();
			}
			sRand += tmp;
